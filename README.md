...
<head>
    <meta charset="UTF-8">
    <title>Vocabulary Practice - aunt, old people's home, cliffs, scissors</title>
    <style>
        :root {
            --primary: #64d404;
            --primary-dark: #2f9e44;
...
<div class="app-container">
    <header>
        ...
        <div class="score-badge" id="scoreDisplay">Score: 0 / 12</div>
    </header>
    ...
    const vocabItems = [
        {
            ...
            example: "My aunt often visits us on Sundays.",
            writingSentence: "My __ always bakes a cake when we go to her house.",
            pronSentence: "His __ lives in Canada and sends him postcards every year.",
            definition: "the sister of your mother or father, or the wife of your uncle"
        },
        {
            word: "old people's home",
            context: "as casa di riposo",
            meaning: "a place where elderly people live and are looked after by staff",
            example: "Her grandfather moved to an old people's home when he needed more care.",
            writingSentence: "The town built a new __ so that elderly residents could receive better care.",
            pronSentence: "She visits her grandmother at the __ every Saturday afternoon.",
            definition: "a residential place where elderly people live and are cared for"
        },
        {
            word: "cliffs",
            context: "",
            meaning: "high, steep rocks, especially by the sea",
            example: "The cliffs along the coast are beautiful but dangerous.",
            writingSentence: "From the top of the __, we could see the beach far below.",
            pronSentence: "Be careful near the edge of the __; the drop is very steep.",
            definition: "high, steep rocks, especially next to the sea"
        },
        {
            word: "scissors",
            context: "",
            meaning: "a tool with two sharp blades used for cutting paper, hair, cloth, and other materials",
            example: "Use the scissors to cut along the line.",
            writingSentence: "She used a pair of __ to cut the picture out of the magazine.",
            pronSentence: "Make sure the __ are kept in a safe place, away from small children.",
            definition: "a cutting tool with two sharp blades, used to cut paper, hair, cloth, etc."
        }
    ];
